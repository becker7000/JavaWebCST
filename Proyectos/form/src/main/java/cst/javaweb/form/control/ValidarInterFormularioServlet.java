...
@WebServlet("/validacion-intermedia")
public class ValidarInterFormularioServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter salida = resp.getWriter()) {
            if (errores.isEmpty()) { // Esto es sólo si no se cometen errores
                ...
                // Despachamos al archiv o formulario_medio.jsp para validarlo
                getServletContext().getRequestDispatcher("/formulario_medio.jsp").forward(req,resp);
            }
        }
